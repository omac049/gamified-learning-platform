...
export class CharacterSelectScene extends Scene {
    ...
    createAriaSprites(graphics) {
        ...
        graphics.beginPath();
        graphics.moveTo(28, 35); graphics.lineTo(36, 35);
        graphics.moveTo(28, 38); graphics.lineTo(36, 38);
        graphics.moveTo(28, 41); graphics.lineTo(36, 41);
        graphics.strokePath();
        ...
        graphics.beginPath();
        graphics.moveTo(26, 8); graphics.lineTo(24, 4);
        graphics.moveTo(32, 8); graphics.lineTo(32, 3);
        graphics.moveTo(38, 8); graphics.lineTo(40, 4);
        graphics.strokePath();
    ...
    createTitanSprites(graphics) {
        ...
        graphics.beginPath();
        graphics.moveTo(26, 16); graphics.lineTo(30, 16);
        graphics.moveTo(28, 14); graphics.lineTo(28, 18);
        graphics.moveTo(34, 16); graphics.lineTo(38, 16);
        graphics.moveTo(36, 14); graphics.lineTo(36, 18);
        graphics.strokePath();
        
        // Communication array with detailed antennas
        graphics.lineStyle(3, 0x374151);
        graphics.beginPath();
        graphics.moveTo(24, 6); graphics.lineTo(22, 2);
        graphics.moveTo(32, 6); graphics.lineTo(32, 1);
        graphics.moveTo(40, 6); graphics.lineTo(42, 2);
        graphics.strokePath();
    ...
    createNexusSprites(graphics) {
        ...
        graphics.beginPath();
        graphics.moveTo(26, 8); graphics.lineTo(24, 4);
        graphics.moveTo(30, 8); graphics.lineTo(30, 3);
        graphics.moveTo(34, 8); graphics.lineTo(34, 3);
        graphics.moveTo(38, 8); graphics.lineTo(40, 4);
        graphics.strokePath();
    ...
    createAtmosphericEffects() {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            const endY = Phaser.Math.Between(this.scale.height - 200, this.scale.height - 100);
    ...
    createHangarPanels() {
        ...
        rightPanel.fillRect(this.scale.width - 80, 120, 80, this.scale.height - 220);
        rightPanel.lineStyle(2, 0x00ffff, 0.6);
        rightPanel.strokeRect(this.scale.width - 80, 120, 80, this.scale.height - 220);
    ...
    create() {
        ...
        if (sceneData && sceneData.preselectedRobot) {
            ...
            console.log(`CharacterSelectScene: Preselected robot: ${sceneData.preselectedRobot}`);
        }
    ...
    initializeLayout(isRecursiveCall = false) {
        ...
        const contentWidth = Math.min(width - (spacing.padding * 2), responsive.maxContentWidth);
    ...
    createEnhancedTitle() {
        ...
        const title = this.add.text(section.x, section.y, "⚔️ ROBOT COMMAND CENTER", {
        ...
        const subtitle = this.add.text(section.x, section.y + 35, "Select your cyber companion for the missions ahead", {
    ...
    createEnhancedNameSection() {
        ...
        this.add.text(section.x, section.y - 25, "🎯 PILOT CALLSIGN", {
        ...
        this.characterCounter = this.add.text(section.x + section.width/2 - 5, section.y + 15, "0/20", {
        ...
        this.validationStatus = this.add.text(section.x - section.width/2 + 5, section.y + 15, "", {
            fontSize: this.getResponsiveFontSize(10),
            fontFamily: 'Courier, monospace',
            fill: '#ff0000',
            fontStyle: 'bold'
    ...
    createInteractiveSuggestions(section) {
        const suggestions = ['GHOST', 'VIPER', 'NOVA', 'CYBER', 'BLADE', 'NEON', 'STORM', 'PHOENIX'];
        ...
        const suggestionTitle = this.add.text(0, -25, "⚡ QUICK SELECT CALLSIGNS:", {
        ...
        const totalWidth = (buttonWidth * suggestions.length) + (buttonSpacing * (suggestions.length - 1));
        ...
        suggestions.forEach((suggestion, index) => {
            ...
            const button = this.add.rectangle(x, y, buttonWidth, 22, 0x00ffff, 0.15)
                .setStrokeStyle(1, 0x00ffff, 0.8);
            
            // Add inner glow effect
            const buttonGlow = this.add.rectangle(x, y, buttonWidth - 2, 20, 0x00ffff, 0.05);
            
            // Button text with enhanced styling
            const text = this.add.text(x, y, suggestion, {
    ...
    createTypingParticles() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            const x = (inputRect.left - canvasRect.left) + Phaser.Math.Between(20, inputRect.width - 20);
            const y = (inputRect.top - canvasRect.top) + Phaser.Math.Between(10, inputRect.height - 10);
    ...
    createEnhancedSuggestionHoverEffect(x, y) {
        ...
        hoverEffect.setPosition(this.suggestionContainer.x + x, this.suggestionContainer.y + y);
    ...
    createEnhancedSuggestionSelectEffect(x, y) {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            burst.setPosition(this.suggestionContainer.x + x, this.suggestionContainer.y + y);
            burst.setDepth(106);
    ...
    createEnhancedRobotPreview() {
        ...
        this.add.text(section.x, section.y - section.height/2 + 30, "🤖 ROBOT\nPREVIEW", {
            fontSize: this.getResponsiveFontSize(18),
            fontFamily: 'Courier, monospace',
            fill: '#00ffff',
            fontStyle: 'bold',
        ...
        try {
            ...
            if (this.textures.exists('aria_idle')) {
                this.previewRobot = this.add.sprite(section.x, section.y, 'aria_idle')
                    .setScale(2.5)
                    .setDepth(50);
            } else {
            ...
            console.warn('CharacterSelectScene: Could not create robot sprite, using fallback:', error);
            this.previewRobot = this.createFallbackRobotGraphic(section.x, section.y);
        }
    ...
    createCompactRobotInfo(section) {
        ...
        this.previewRobotName = this.add.text(section.x, section.y - section.height/2 + 90, 'ARIA', {
        ...
        this.previewRobotSpecialty = this.add.text(section.x, section.y - section.height/2 + 110, 'CYBER HACKER', {
            fontSize: this.getResponsiveFontSize(12),
            fontFamily: 'Courier, monospace',
            fill: '#ffff00',
            fontStyle: 'bold',
        ...
        this.previewRobotDescription = this.add.text(section.x, section.y + section.height/2 - 100, 'Sophisticated, analytical, adaptive', {
            fontSize: this.getResponsiveFontSize(10),
            fontFamily: 'Courier, monospace',
            fill: '#ffffff',
            alpha: 0.7,
    ...
    createCompactDemoButtons(section) {
        ...
        const totalWidth = (buttonWidth * buttons.length) + (buttonSpacing * (buttons.length - 1));
        ...
        buttons.forEach((btn, index) => {
            ...
            const button = this.add.rectangle(x, buttonY, buttonWidth, 25, btn.color, 0.3)
                .setStrokeStyle(2, btn.color, 0.8)
                .setInteractive({ useHandCursor: true })
                .setDepth(52);
            
            const text = this.add.text(x, buttonY, btn.text, {
                fontSize: this.getResponsiveFontSize(9),
                fontFamily: 'Courier, monospace',
                fill: '#ffffff',
                fontStyle: 'bold'
    ...
    createEnhancedCharacterSelection() {
        ...
        // Enhanced section header
        this.add.text(section.x, section.y - section.height/2 + 30, "⚔️ ROBOT\nSELECTION", {
            fontSize: this.getResponsiveFontSize(18),
            fontFamily: 'Courier, monospace',
            fill: '#ff00ff',
            fontStyle: 'bold',
    ...
    createVerticalCharacterCards(section) {
        ...
        Object.values(this.characterTypes).forEach((charType, index) => {
            ...
            const cardBg = this.add.rectangle(0, 0, cardWidth, cardHeight, 0x000000, 0.85)
                .setStrokeStyle(2, charType.accentColor, 0.95);
            
            const cardInner = this.add.rectangle(0, 0, cardWidth - 6, cardHeight - 6, charType.baseColor, 0.12);
            
            // Character info layout optimized for horizontal card
            const name = this.add.text(-cardWidth/2 + 15, -cardHeight/3, charType.name, {
            ...
            const specialty = this.add.text(-cardWidth/2 + 15, 0, charType.specialty, {
                fontSize: this.getResponsiveFontSize(10),
                fontFamily: 'Courier, monospace',
                fill: '#ffff00',
                fontStyle: 'bold'
            ...
            const charIcon = this.add.text(cardWidth/2 - 20, 0, charType.icon, {
                fontSize: this.getResponsiveFontSize(20)
            }).setOrigin(0.5);
            ...
            const stats = this.add.text(-cardWidth/2 + 15, cardHeight/3, statsText, {
            ...
            const selector = this.add.rectangle(0, 0, cardWidth + 6, cardHeight + 6, 0x000000, 0)
                .setStrokeStyle(3, 0xffff00, 0.95)
                .setVisible(false);
            
            // Add glow effect for selection
            const glowEffect = this.add.rectangle(0, 0, cardWidth + 10, cardHeight + 10, 0xffff00, 0.1)
                .setVisible(false);
            
            // Add all elements to container
            cardContainer.add([glowEffect, selector, cardInner, cardBg, name, specialty, charIcon, stats]);
    ...
    createEnhancedBonusSelection() {
        ...
        this.add.text(section.x, section.y - section.height/2 + 30, "⚡ MISSION\nLOADOUT", {
            fontSize: this.getResponsiveFontSize(18),
            fontFamily: 'Courier, monospace',
            fill: '#00ff00',
            fontStyle: 'bold',
        ...
        this.add.text(section.x, section.y - section.height/2 + 70, "Select starting equipment", {
            fontSize: this.getResponsiveFontSize(10),
            fontFamily: 'Courier, monospace',
            fill: '#00ffff',
            alpha: 0.8,
    ...
    createVerticalBonusCards(section) {
        ...
        bonuses.forEach((bonus, index) => {
            ...
            const bonusBtn = this.add.rectangle(0, 0, cardWidth, cardHeight, bonus.color, 0.15)
                .setStrokeStyle(2, bonus.color, 0.9);
            
            const bonusInner = this.add.rectangle(0, 0, cardWidth - 6, cardHeight - 6, bonus.accentColor, 0.05);
            ...
            const icon = this.add.text(-cardWidth/2 + 25, -cardHeight/4, bonus.icon, {
                fontSize: this.getResponsiveFontSize(16)
            }).setOrigin(0.5);
            
            const title = this.add.text(-cardWidth/2 + 50, -cardHeight/3, bonus.title, {
                fontSize: this.getResponsiveFontSize(12),
                fontFamily: 'Courier, monospace',
                fill: '#ffffff',
                fontStyle: 'bold'
            ...
            const description = this.add.text(-cardWidth/2 + 50, cardHeight/4, bonus.description, {
                fontSize: this.getResponsiveFontSize(10),
                fontFamily: 'Courier, monospace',
                fill: '#00ffff',
                alpha: 0.9,
            ...
            // Add all elements to container
            bonusContainer.add([glowEffect, selector, bonusInner, bonusBtn, iconGlow, icon, title, description]);
    ...
    playRobotDemo(action) {
        ...
        this.updateEnergyField(this.previewRobot.x, this.previewRobot.y, energyColor);
    ...
    previewRobotInDisplay(charType) {
        ...
        if (this.previewRobot.robotBody) {
            ...
            try {
                ...
                if (this.textures.exists(textureKey)) {
                    ...
                    console.warn(`CharacterSelectScene: Texture ${textureKey} not found, using fallback`);
                    // Keep current texture or use a default
                }
            } catch (error) {
                console.warn('CharacterSelectScene: Error setting robot texture:', error);
            }
        }
        ...
        // Update energy field color
        this.updateEnergyField(this.previewRobot.x, this.previewRobot.y, charType.baseColor);
    ...
    createEnhancedSelectionBurst(x, y, color) {
        ...
        // Screen flash effect
        const flash = this.add.rectangle(0, 0, this.scale.width, this.scale.height, color, 0.3)
            .setOrigin(0, 0)
            .setDepth(70);
    ...
    updateReadyState() {
        const hasName = this.characterData.name && this.characterData.name.trim().length >= 2;
    ...
    showEnhancedEntranceAnimation() {
        ...
        const titleElements = this.children.list.filter(child => 
            child.depth === 100 || child.depth === 101
        );
        ...
        const navButtons = this.children.list.filter(child => 
            child.depth === 100 && (child.x < 300 || child.x > this.scale.width - 300)
        );
    ...
    startAdventure() {
        ...
        const initialData = {
            ...
            coinBalance: 100 + (this.characterData.startingBonus?.id === 'coins' ? 300 : 0),
            totalScore: 0,
            weeksCompleted: [],
            badges: 0,
            ...
            equippedItems: {
                ...
                powerUp: this.characterData.startingBonus?.id === 'shield' ? 'shield' : null,
                tool: null,
                decoration: null
            },
            dailyRewards: {
            ...
            totalCoinsEarned: 100 + (this.characterData.startingBonus?.id === 'coins' ? 300 : 0),
            experienceMultiplier: this.characterData.startingBonus?.id === 'experience' ? 1.5 : 1.0
        };
    ...
    showEnhancedSuccessAnimation() {
        ...
        for (let i = 0; i < 30; i++) {
            ...
            const sparkleTypes = ['✨', '⭐', '💫', '🌟'];
            const sparkle = this.add.text(x, y, Phaser.Math.RND.pick(sparkleTypes), {
    ...
    getArmorBonuses(mechType) {
        ...
        if (this.progressTracker.progress && this.progressTracker.progress.armorUpgrades) {
            Object.keys(this.progressTracker.progress.armorUpgrades).forEach(armorId => {
                if (this.progressTracker.progress.armorUpgrades[armorId] && armorId.startsWith(mechType + '_')) {
    ...
    createHolographicScanLines(section) {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            scanLine.beginPath();
            scanLine.moveTo(section.x - section.width/2 + 20, section.y - section.height/2 + 40);
            scanLine.lineTo(section.x + section.width/2 - 20, section.y - section.height/2 + 40);
            scanLine.strokePath();
    ...
    createCharacterSelectionFeedback(charType) {
        ...
        const flash = this.add.rectangle(0, 0, this.scale.width, this.scale.height, charType.baseColor, 0.15)
            .setOrigin(0, 0)
            .setDepth(200);
    ...
    updateRobotPreviewWithTransition(typeId, charType) {
                ...
                if (this.previewRobot.robotBody) {
                    ...
                    try {
                        ...
                        if (this.textures.exists(textureKey)) {
                            ...
                            console.warn(`CharacterSelectScene: Texture ${textureKey} not found, keeping current texture`);
                            // Keep current texture
                        }
                    } catch (error) {
                        console.warn('CharacterSelectScene: Error updating robot texture:', error);
                    }
                }
        ...
        const textElements = [this.previewRobotName, this.previewRobotSpecialty, this.previewRobotDescription];
    ...
    createSoundEffectSimulation() {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            soundWave.strokeCircle(this.scale.width / 2, this.scale.height / 2, 50 + (i * 20));
    ...
    createCharacterAnnouncement(charType) {
        ...
        const announcement = this.add.text(this.scale.width / 2, this.scale.height / 2 - 100, 
    ...
    createEnhancedNavigationButtons() {
        ...
        const backBtn = this.add.rectangle(section.x - 150, section.y, 140, 45, 0x374151, 0.9)
            .setStrokeStyle(2, 0x00ffff, 0.8)
            .setInteractive({ useHandCursor: true })
            .setDepth(100);
        
        this.add.text(section.x - 150, section.y, "← BACK", {
            fontSize: this.getResponsiveFontSize(14),
            fontFamily: 'Courier, monospace',
            fill: '#ffffff',
            fontStyle: 'bold'
        ...
        this.startBtn = this.add.rectangle(section.x + 150, section.y, 180, 45, 0x374151, 0.9)
            .setStrokeStyle(2, 0x9ca3af, 0.8)
            .setInteractive({ useHandCursor: true })
            .setDepth(100);
        
        this.startBtnText = this.add.text(section.x + 150, section.y, "DEPLOY →", {
            fontSize: this.getResponsiveFontSize(14),
            fontFamily: 'Courier, monospace',
            fill: '#ffffff',
            fontStyle: 'bold'
        ...
        this.readinessIndicator = this.add.text(section.x, section.y - 20, "⚠️ Enter callsign to deploy", {
    ...
    getResponsiveFontSize(baseSize) {
        const scaleFactor = Math.min(this.scale.width / 1200, this.scale.height / 800);
