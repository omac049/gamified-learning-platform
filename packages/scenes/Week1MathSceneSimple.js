...
export class Week1MathSceneSimple extends Scene {
    ...
    createUI() {
        ...
        // Health bar
        this.healthBarBg = this.add.rectangle(this.scale.width - 120, 30, 200, 20, 0x333333);
        this.healthBar = this.add.rectangle(this.scale.width - 120, 30, 200, 16, 0x00ff00);
        ...
        // Math power bar
        this.mathPowerBarBg = this.add.rectangle(this.scale.width - 120, 70, 200, 20, 0x333333);
        this.mathPowerBar = this.add.rectangle(this.scale.width - 120, 70, 0, 16, 0xffff00);
    ...
    showWelcomeMessage() {
        ...
        const welcomeText = this.add.text(centerX, centerY - 50, 'MATH COMBAT ARENA', {
            fontSize: '36px',
            fontFamily: 'Courier, monospace',
            color: '#00ffff',
            stroke: '#000000',
        ...
        const instructionText = this.add.text(centerX, centerY, 'Solve math problems to power up!\nUse WASD to move, SPACE to shoot', {
            fontSize: '18px',
            fontFamily: 'Courier, monospace',
            color: '#ffffff',
            align: 'center'
    ...
    shootBullet() {
        const bullet = this.add.circle(this.player.x, this.player.y - 20, 3, 0x00ff88);
        bullet.speed = 500;
        bullet.damage = 20;
    ...
    showMathQuizUI() {
        ...
        // Background
        this.mathQuizBg = this.add.rectangle(centerX, centerY, 400, 300, 0x000000, 0.8);
        this.mathQuizBg.setStrokeStyle(3, 0x00ffff);
        
        // Question
        this.mathQuizQuestion = this.add.text(centerX, centerY - 80, this.currentQuestion.question, {
            fontSize: '32px',
            fontFamily: 'Courier, monospace',
            color: '#ffffff'
        }).setOrigin(0.5);
        ...
        // Instructions
        this.mathQuizInstructions = this.add.text(centerX, centerY + 100, 'Press 1, 2, 3, or 4 to answer', {
            fontSize: '16px',
            fontFamily: 'Courier, monospace',
            color: '#ffffff'
        }).setOrigin(0.5);
    ...
    showGameOverScreen(accuracy) {
        ...
        // Background
        const gameOverBg = this.add.rectangle(centerX, centerY, this.scale.width, this.scale.height, 0x000000, 0.8);
