export class FXManager {
  ...
  createErrorEffect(x, y, scale = 1) {
    ...
    // X mark effect
    const xMark1 = this.scene.add
      .rectangle(x, y, 30 * scale, 4 * scale, 0xff0000)
      .setRotation(Math.PI / 4)
      .setAlpha(0)
      .setBlendMode('ADD');

    const xMark2 = this.scene.add
      .rectangle(x, y, 30 * scale, 4 * scale, 0xff0000)
      .setRotation(-Math.PI / 4)
      .setAlpha(0)
      .setBlendMode('ADD');
  ...
  createEnhancedButton(x, y, width, height, text, style = {}) {
    ...
    const bg = this.scene.add
      .rectangle(x, y, width, height, finalStyle.backgroundColor)
