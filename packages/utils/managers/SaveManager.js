export class SaveManager {
  ...
  hasSaveData() {
    return (
      localStorage.getItem(this.cookieName) !== null ||
      this.getCookie(this.cookieName) !== null
    );
  }
  ...
  migrateSaveData(oldSaveData) {
    console.log(
      'SaveManager: Migrating save data from version',
      oldSaveData.version,
      'to',
      this.version
    );
  ...
  enableAutoSave(progressTracker, intervalMs = 30000) {
