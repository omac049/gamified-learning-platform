...
export class RealTimeCombatManager {
    ...
    createWeaponEffects(weapon, targetX, targetY) {
        ...
        if (!weapon || !weapon.effects) {
            console.warn('createWeaponEffects: weapon or weapon.effects not available');
            return;
        }
...
class BulletProjectile extends Phaser.GameObjects.Graphics {
    ...
    initialize(x, y, config) {
        // Validate parameters
        if (!config) {
            console.error('BulletProjectile.initialize: config parameter is required');
            return;
        }
...
class LaserBeam extends Phaser.GameObjects.Graphics {
    ...
    initialize(startX, startY, endX, endY, config) {
        ...
        if (typeof startX === 'undefined' || typeof startY === 'undefined' || 
            ...
            console.error('LaserBeam.initialize: startX, startY, endX, endY parameters are required');
            return;
        }
