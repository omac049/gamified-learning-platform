...
export class EnhancedButton extends GameObjects.Container {
    ...
    createButton() {
        ...
        // Button text
        this.textObject = this.scene.add.text(0, 0, this.buttonText, {
...
export class EnhancedSlider extends GameObjects.Container {
    ...
    createSlider() {
        ...
        this.handle = this.scene.add.circle(
            0, 0,
            this.style.handleSize / 2,
            this.style.handleColor
        ).setStrokeStyle(2, 0x000000)
          .setInteractive({ useHandCursor: true, draggable: true });
        
        // Handle glow
        this.handleGlow = this.scene.add.circle(
            0, 0,
            this.style.handleSize / 2 + 3,
            this.style.fillColor,
            0
        ).setBlendMode('ADD');
...
export class EnhancedTooltip extends GameObjects.Container {
    ...
    createTooltip() {
        // Text object
        this.textObject = this.scene.add.text(0, 0, this.tooltipText, {
            fontSize: this.style.fontSize,
            fontFamily: 'Arial, sans-serif',
            fill: this.style.textColor,
