...
export class Preloader extends Phaser.Scene {
    ...
    createCyberLoadingScreen() {
        ...
        this.add.text(this.scale.width / 2, this.scale.height / 2 - 120, 
    ...
    createCyberLoadingBar() {
        ...
        this.loadingBarGlow = this.add.rectangle(
            this.scale.width / 2 - 210, 
            this.scale.height / 2 + 55, 
            0, 
            20, 
    ...
    createEnergyRings() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            ring.strokeCircle(this.scale.width / 2, this.scale.height / 2, 100 + (i * 30));
    ...
    createCompletionEffect() {
        ...
        const readyText = this.add.text(this.scale.width / 2, this.scale.height / 2 + 90, 
        ...
        // Screen flash effect
        const flash = this.add.rectangle(0, 0, this.scale.width, this.scale.height, 0x00ff00, 0.3)
            .setOrigin(0, 0);
